...
This region is context-sensitive and will display different info based on the active channel. It may also be called "friends" if you are viewing your friends list (usually when Discord first opens).
